---
url: https://www.braze.com/docs/partners/message_orchestration/templates/better_email
slug: docs__partners__message_orchestration__templates__better_email
title: "Better Email"
description: "This reference article outlines the partnership between Braze and Better Email, a collaborative email creation platform built around an Email Design System that lets you..."
...
This integration is maintained by Better Email.
...
## Prerequisites
 ...
 Better Email account | 
 A Better Email account with admin access to create integrations | 
...
This can be created in the Braze dashboard from Settings > API Keys. | 
 ...
 Braze REST endpoint | 
 Your REST endpoint URL. Use the REST host, not the dashboard URL—for example, rest.fra-01.braze.eu. | 
...
- Enter a name for the integration (for example, Braze).
 
- Select Braze as the type.
 
- Optionally, restrict the integration to specific users or groups under Access.
...
- Open the Braze integration in Better Email.
 
- Enable Sync recipient fields.
 
- Select Save.
 
- Go to Recipient Fields.
 
- Select Sync from next to your integration.
...
For more help, contact Better Email support.
