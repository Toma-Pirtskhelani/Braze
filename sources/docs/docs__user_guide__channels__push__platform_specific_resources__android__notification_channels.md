---
url: https://www.braze.com/docs/user_guide/channels/push/platform_specific_resources/android/notification_channels
slug: docs__user_guide__channels__push__platform_specific_resources__android__notification_channels
title: "Notification channels"
description: "This reference article covers Android push notification channel topics like Android O transition, how to add a channel to Braze, setting a fallback channel, and..."
...
Company LMN defines two channels in their application code, “Promotions” and “Order Updates” 
...
The SDK default channel, “Marketing” is only created and used if the company attempts to send a notification through an invalid channel ID or if explicitly selected | 
 ...
 Company HIJ updates to Android O but does not update to Braze Android SDK to 2.1.0 or later | 
 Notifications sent to users running Android O or later do not appear | 

## Adding channels to the Braze dashboard

- Open or create any campaign or Canvas that includes an Android push.
 
- Navigate to the Android push message composer.
 
- Select Manage Notification Channels. Any channels added here will be available globally for all campaigns and Canvases. You must have “Manage Apps” permissions for your workspace to manage channels.
...
- Repeat steps 4 and 5 for each notification channel that you’d like to add.
...
- Select Manage Notification Channels after expanding the notification channel options.
...
- Select the channel you’d like to use from the dropdown. If you do not have a dropdown but rather have the following view, you’ll need to add channels before selecting them for campaigns.
