---
url: https://www.braze.com/docs/user_guide/brazeai/decisioning_studio/launch_agents
slug: docs__user_guide__brazeai__decisioning_studio__launch_agents
...
- Review your agent configuration to ensure all settings are correct.
 
- Verify that your data connections and orchestration integrations are active.
 
- Work with your AI Decisioning Services team to activate the agent.
...
For detailed requirements on preparing these critical feedback data assets, see Preparing your data sources.
