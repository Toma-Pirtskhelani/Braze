---
url: https://www.braze.com/docs/partners/data_and_analytics/analytics/kickbox
slug: docs__partners__data_and_analytics__analytics__kickbox
title: "Kickbox"
...
Kickbox is an all-in-one email verification platform, packed with the features, integrations, and security you need to keep your email data clean and deliverable. The Kickbox integration improves the deliverability of your Braze campaigns by using Kickbox email verification to identify undeliverable and low quality email addresses before you hit send.
...
## Prerequisites
 ...
 Kickbox account | 
 An active Kickbox account is required to use this integration. | 

 Braze REST API Key | 
 A Braze REST API key with users.track permissions. 

This can be created in the Braze dashboard by going to Settings > APIs and Identifiers > API Keys | 

 Request access to the integration. | 
 Ask the Kickbox support team to grant you access to the Braze integration. | 

## Integration

To integrate with Kickbox, follow the steps in Integrating with Braze.
...
- In Braze, go to Audience > Segments > Create Segment.
 
- In the Filter Group section, add the Custom Attribute filter and select “result” in the dropdown.
