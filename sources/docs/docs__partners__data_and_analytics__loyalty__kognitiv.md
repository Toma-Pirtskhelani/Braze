---
url: https://www.braze.com/docs/partners/data_and_analytics/loyalty/kognitiv
slug: docs__partners__data_and_analytics__loyalty__kognitiv
title: "Kognitiv Inspire"
description: "Kognitiv Inspire is a loyalty technology system that allows you to implement and evaluate your loyalty strategy, offering innovative capabilities and tailored member communications for..."
...
Kognitiv Inspire is a loyalty technology system that helps unlock unparalleled customer experiences through results-driven loyalty programs that amplify customer engagement, augment spending, and celebrate loyal behavior.
...
## Prerequisites
 ...
 Kognitiv account | 
 A Kognitiv account is required to take advantage of this partnership. | 

 Kognitiv API key | 
 A Kognitiv REST API key. This can be created within the API Security Tokens page. | 
