---
url: https://www.braze.com/docs/user_guide/channels/whatsapp/meta_resources
slug: docs__user_guide__channels__whatsapp__meta_resources
...
Before the username feature is broadly available, Meta may have pre-reserved a username for your business—typically matching an existing Facebook Page or Instagram username. You can claim this reserved username or choose a different one through WhatsApp Manage. Claimed usernames are not activated until Meta makes the feature available.
...
For more information, see Meta’s documentation on business usernames.
...
For more information, see Meta’s documentation on template archival.
...
### November 2025: Marketing messages API for WhatsApp (formerly Marketing Messages Lite API)
...
The specific limit varies by user, depending on their engagement level. Learn more about WhatsApp’s per-user marketing template message limits WhatsApp’s per-user marketing template message limits documentation.

### January 2025: WhatsApp pausing marketing message sending to US users starting April 1

Last Updated January 2025

WhatsApp will pause marketing message sending to US users (people with US phone numbers) starting April 1, 2025. Utility, service, authentication, and response messages will still be allowed in the US.
...
Meta recently updated their opt-in policy. Instead of requiring channel-specific consent, businesses can now message users on the platform if:

- The person has given their phone number.
 
- The person provided opt-in permission for general messaging, not just WhatsApp.
...
If a marketing template message is not delivered to a given user due to the limit, Cloud API will return error code 131026. Note, however, that these error codes cover a wide range of issues that can result in non-delivery of a message, and for privacy reasons, Meta will not disclose if in fact the message was not delivered due to the limit. Refer to Cloud API’s Troubleshooting document for descriptions of non-delivery reasons and what you can do to determine their underlying cause.
...
For more information on this deliverability update, including details on monitoring your deliverability and other best practices for marketing messaging on WhatsApp, refer to our recent blog post.
...
Meta intends to continue such experimentation on the WhatsApp platform. Please see Meta’s documentation for more information.
...
This 130472 error code will state “User’s number is part of an experiment.” Please see Meta’s documentation for more information on WhatsApp Cloud API error codes.
