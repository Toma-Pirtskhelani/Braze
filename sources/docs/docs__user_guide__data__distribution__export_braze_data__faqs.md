---
url: https://www.braze.com/docs/user_guide/data/distribution/export_braze_data/faqs
slug: docs__user_guide__data__distribution__export_braze_data__faqs
...
While CSV files are usually automatically opened in Excel by default, this may not always be the case. Refer to the Windows and Apple troubleshooting articles for steps to set Excel as your default program.

To convert a CSV to XLSX or XLS, or get rid of the comma between data values, refer to this guide for importing CSVs into Excel.

If you find that leading zeroes are stripped from user IDs in your CSV export, this happens because Excel treats the numbers in a CSV as data instead of text. To resolve this, run the Excel Text Import Wizard.
