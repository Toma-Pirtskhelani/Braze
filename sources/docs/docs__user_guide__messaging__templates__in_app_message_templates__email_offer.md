---
url: https://www.braze.com/docs/user_guide/messaging/templates/in_app_message_templates/email_offer
slug: docs__user_guide__messaging__templates__in_app_message_templates__email_offer
title: "Email sign-up with special offer"
...
To get started building your email sign-up form, select the Email sign-up page, then select the email capture element in the editor. By default, collected email addresses will have the global subscription group Subscribed. To opt in users to specific subscription groups, refer to Updating email subscription states.
...
Customize the look and feel of your special offer using the drag-and-drop in-app message components.
