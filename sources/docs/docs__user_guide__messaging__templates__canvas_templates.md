---
url: https://www.braze.com/docs/user_guide/messaging/templates/canvas_templates
slug: docs__user_guide__messaging__templates__canvas_templates
title: "Create a Canvas template"
description: "Create and manage reusable Canvas templates, or get started with pre-built Braze templates for common use cases."
...
- From Content: Go to Content > Canvas and find your desired template in Canvas templates. Then, select the menu followed by Apply template. This brings you to a new Canvas with the template applied in the Canvas composer.

### Available Braze templates

For a list of available Canvas templates, refer to Braze Canvas templates. For details on using eCommerce Canvas templates, refer to How to use eCommerce recommended events.
