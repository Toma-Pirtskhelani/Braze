---
url: https://www.braze.com/docs/user_guide/brazeai/item_recommendations
slug: docs__user_guide__brazeai__item_recommendations
...
selections. However, selections with Liquid cannot be used in AI recommendations, so keep that in mind when building your catalog selections.
...
- A method for tracking purchases: a purchase object, a custom event, or an order placed event

Setting it up

- Create an AI item recommendation.
 
- Set the Type to AI Personalized.
 
- Select your catalog.
 
- (Optional) Add a selection to filter your recommendation to only relevant items.
 
- Choose how you currently track purchase events and the corresponding event property.
 
- Train the recommendation.
 
- Use the recommendation in messaging.
...
- Set the Type to Most popular.
 
- Select your catalog.
 
- (Optional) Add a selection to filter your recommendation to only relevant items. For example, the food delivery service might have a selection to filter for restaurant location or type of dish.
 
- Choose how you currently track events and the corresponding event property.
...
- Set the Type to Most recent.
 
- Select your catalog.
 
- (Optional) Add a selection to filter your recommendation to only relevant items.
 
- Choose Custom Event and select your custom event for likes from the list.
...
- Choose Custom Event and select your custom event for views from the list.
...
- Choose Custom Event and select your custom event for added to cart from the list.
...
- Choose Custom Event and select your custom event for clicks from the list.
...
- Set the Type to Trending.
 
- Select your catalog.
 
- (Optional) Add a selection to filter your recommendation to only relevant items.
 
- Choose either a purchase event or a custom event that tracks purchases, along with the corresponding property.
...
- Choose your custom event for tracking likes, along with the corresponding property.
...
- Create a selection based on your catalog. Make sure your catalog has a time field (field with a Data type set to Time) that corresponds to the date the item was added.
 
- (Optional) Add any filters if desired.
 
- Make sure Randomize Sort Order is turned off.
 
- For Sort Field, select your date added field.
 
- Set Sort Order to descending.
 
- Use the selection in messaging.
...
- Create a selection based on your catalog.
 
- (Optional) Add any filters if desired.
 
- Turn on Randomize Sort Order.
...
- Create a new item recommendation with the desired property name configuration.
 
- Verify that the training completes successfully.
 
- Update your messaging to reference the new recommendation instead of modifying an active recommendation directly.
