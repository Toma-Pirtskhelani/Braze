---
url: https://www.braze.com/docs/api/endpoints/export/kpi/get_kpi_daily_new_users_date
slug: docs__api__endpoints__export__kpi__get_kpi_daily_new_users_date
title: "Export daily new users by date"
...
To use this endpoint, you’ll need an API key with the kpi.new_users.data_series permission.
