---
url: https://www.braze.com/docs/user_guide/data/distribution/export_braze_data/export_campaign_results_data
slug: docs__user_guide__data__distribution__export_braze_data__export_campaign_results_data
title: "Export campaign data"
description: "This reference article covers how to export campaign results data from single, multi-channel, or multivariate campaigns. The article also lists how to export user data..."
...
From the Campaigns page of the dashboard, select the campaign you want to view and scroll down to the historical performance graphs, which can be exported.

This page covers how to export campaign results data from single, multi-channel, and multivariate campaigns, and how to export user data from the recipients.
...
Can’t see the User Data button? To export user data, you need the Export User Data permissions for that workspace.
...
If you’ve linked your Amazon S3 credentials to Braze, then the CSV will also be uploaded in your S3 bucket. Otherwise, the link emailed to you will expire in a few hours.

The exported file includes the same user data fields that are included when you export user data for a segment. In addition to those data fields, if you choose “Export All Recipient Data,” then the exported file will also contain the following data for each user:
...
For help with CSV and API exports, check out Export troubleshooting.
