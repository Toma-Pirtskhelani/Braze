---
url: https://www.braze.com/docs/partners/message_personalization/localization/lilt
slug: docs__partners__message_personalization__localization__lilt
title: "LILT"
...
This integration is maintained by LILT.
...
## Prerequisites
 ...
 A LILT account | 
 A LILT account is required to take advantage of this partnership. | 
...
- templates.translations.source.get
- templates.translations.update
- templates.translations.get
- templates.translations.all.get. 
...
- Log into LILT, then go to Connect > New Connector > Braze.
...
- Select Verify to test the setup. After the connection is confirmed, save the configuration.
...
- After setting up the LILT Braze Connector, use Liquid translation tags within your Braze email templates to identify content for translation.
