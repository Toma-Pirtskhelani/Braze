---
url: https://www.braze.com/docs/partners/data_and_analytics/customer_data_platform/crowdtwist
slug: docs__partners__data_and_analytics__customer_data_platform__crowdtwist
title: "Oracle Crowdtwist"
...
Live Push User Profile: Includes creations of new profiles and updates to existing profiles.

- 
 
Live Push User Activity: Includes data on user activity completions.

- 
 
Live Push User Redemption: Includes data on user reward redemptions.
...
## Prerequisites
 ...
 Oracle Crowdtwist account | 
 An Oracle Crowdtwist Account is required to take advantage of this partnership. | 

 Braze Data Transformation Endpoint | 
 This integration relies on Braze’s Data Transformation Tool. When you create a Data Transformation, Braze generates a unique endpoint that you can add as a destination for Crowdtwist’s Data Push. | 

## Integration

Braze and Oracle Crowdtwist have created Data Transformation templates to help our customers develop their own Data Transformations which leverage the User Profile, User Redemption, and User Activity events.
...
- user profile event template
 
- user activity event template
 
- redemption event template
