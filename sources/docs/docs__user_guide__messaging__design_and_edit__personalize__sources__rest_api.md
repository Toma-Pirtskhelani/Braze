---
url: https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/sources/rest_api
slug: docs__user_guide__messaging__design_and_edit__personalize__sources__rest_api
title: "REST API"
...
## Common use cases
 ...
 Fetch personalized product picks from a recommendation engine | 

 Real-time pricing or inventory | 
 Display current prices or stock levels at send time | 

 Weather-based content | 
 Pull local weather data to tailor messaging | 

 Loyalty point balances | 
 Show up-to-date rewards or account balances | 

 Content feeds | 
 Insert the latest blog posts, articles, or news items | 
...
For more information, see Making a Connected Content API call.
...
For more information, see Aborting Connected Content.
...
For the complete Connected Content reference, see Connected Content.
