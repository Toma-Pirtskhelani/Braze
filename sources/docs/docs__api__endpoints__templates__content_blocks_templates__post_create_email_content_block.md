---
url: https://www.braze.com/docs/api/endpoints/templates/content_blocks_templates/post_create_email_content_block
slug: docs__api__endpoints__templates__content_blocks_templates__post_create_email_content_block
...
You can also call this endpoint through the Braze MCP server using the create_content_block function. This lets AI tools like Claude and Cursor create content blocks through natural language prompts.
...
## Request parameters
 ...
 Required | 
 String | 
 HTML or text content within the Content Block. | 
