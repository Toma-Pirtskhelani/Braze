---
url: https://www.braze.com/docs/user_guide/data/activation/accounts
slug: docs__user_guide__data__activation__accounts
...
Braze includes account objects with standard fields by default. You can add and remove custom fields based on your use case.
 ...
 string | 
 Yes | 
 Your system ID for the account (for example, CRM ID). Must be unique in your workspace. | 
 ...
 string | 
 No | 
 Account type, such as customer, partner, or reseller. | 
...
- Select Create filter, then select Data Object filters.
 
- Define your account criteria.

For details, see Calculated filters.
...
- Add your preconfigured calculated filter for account criteria.
 
- Add any additional user attribute filters.
...
For endpoint details, refer to Data Objects endpoints.

For authentication and REST endpoint basics, refer to Braze API overview.

## Frequently asked questions

### Can I add custom fields to accounts?

Yes. You can define and manage custom account fields in your workspace. For field requirements, see Account data model.
