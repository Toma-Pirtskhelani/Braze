---
url: https://www.braze.com/docs/user_guide/channels/email/email_setup/setting_up_ips_and_domains/amazon_ses
slug: docs__user_guide__channels__email__email_setup__setting_up_ips_and_domains__amazon_ses
title: "Amazon SES setup"
description: "This reference article covers how to set up Amazon SES as your email service provider."
...
- Cluster: eu-02
 ...
 eu02_braze_marketing | 
 1 IP | 
 eu02_braze_marketing_set1 | 
 demo.braze.com | 
 clicks.demo.braze.com | 

 eu02_braze_transactional | 
 1 IP | 
 eu02_braze_transactional_set1 | 
 dev.braze.com | 
 clicks.dev.braze.com | 
...
### One click tracking domain for each sending domain
 ...
 braze_marketing - 1 IP | 
 braze_marketing_set1 | 
 email1.example.com | 
 clicks.email1.example.com | 

 braze_marketing - 1 IP | 
 braze_marketing_set2 | 
 email2.example.com | 
 clicks.email2.example.com | 

 braze_marketing - 1 IP | 
 braze_marketing_set3 | 
 email3.example.com | 
 clicks.email3.example.com | 

 braze_marketing - 1 IP | 
 braze_marketing_set4 | 
 email4.example.com | 
 clicks.email4.example.com | 
