---
url: https://www.braze.com/docs/user_guide/channels/email/customize/amp_for_email
slug: docs__user_guide__channels__email__customize__amp_for_email
title: "AMP for email"
...
With AMP for email, you can add interactive elements to your emails and elevate your communications with your customers, delivering a full experience directly to your user’s inbox. AMP makes this possible through its use of various components that can be used to help build exciting email offerings such as surveys, feedback questionnaires, voting campaigns, reviews, subscription centers, and more. Tools like these can offer opportunities to increase engagement and retention.
...
Braze is not responsible for users registering with Google or meeting the necessary security requirements. AMP for email is available for SparkPost and SendGrid only.
 ...
 AMP for email turned on | 
 AMP is available for all users. | 

 Gmail account enablement | 
 See Enabling Gmail account. | 

 Google sender authentication | 
 Gmail authenticates the sender of AMP emails with DKIM, SPF, and DMARC. These must be set up for your account. 
...
- Domain-based Message Authentication, Reporting, and Conformance(DMARC) | 
 ...
 AMP email elements | 
 A compelling AMP email includes the strategic use of various components. Refer to the Essentials tab in the Components section. | 
...
For a full list of supported email clients, refer to AMP documentation.
...
You can also use AMP for email with our API. If you use any of the Braze Messaging endpoints to send an email, add amp_body as an object specification as shown in the following section.
...
- Sample code to see how the final product should look.
 
- AMP email components library
...
Each of these elements is required in the body of your AMP email.
 ...
 ⚡4email or amp4email | 
 Identifies your email as an AMP HTML email. | 
 <!doctype html> 
 <html ⚡4email> 
 <head> | 
 ...
 <script> | 
 Allows AMP to run in your email using JavaScript. | 
 <script async src="https://cdn.ampproject.org/v0.js"></script> | 

 CSS Boilerplate | 
 Hides content until AMP is loaded. 
 Email providers who support AMP emails enforce security checks that only allow vetted AMP scripts to run in their clients. | 
...
Use these components to create dynamic layouts and behaviors in your emails.
 ...
 amp-accordion | 
 Allows users to view the content outline and jump to any section. | 
 <script async custom-element="amp-accordion" src="https://cdn.ampproject.org/v0/amp-accordion-0.1.js"></script> | 

 Forms 

 amp-form | 
 Create forms to submit input fields in an AMP document. | 
 <script async custom-element="amp-form" src="https://cdn.ampproject.org/v0/amp-form-0.1.js"></script> | 

note

Any component that requires authenticating the user must use Google access tokens or proxy assertion tokens.
...
Get fancy with AMP’s components that can help you cater your email to your audience.
 ...
 amp-anim | 
 Displays an animated image (usually a GIF) managed via runtime. | 
...
Any component that requires authenticating the user must use Google access tokens or proxy assertion tokens.
 ...
 amp-bind | 
 Adds custom stateful interactivity to your AMP pages via data binding and JavaScript-like expressions. | 
...
Total Opens is the total number of messages that were opened.
 ...
 For AMP emails, this is the total opens for the HTML and plaintext versions. | 

 Total Clicks | 

Total Clicks is the number (or percentage) of unique recipients who clicked on a link in the delivered message.

 For AMP emails, this is the total clicks in the HTML and plaintext versions. | 
...
- Testing according to these Gmail guidelines.
 
- Using the Gmail AMP for Email Playground to validate AMP markup.
...
If none of these conditions are causing the error, contact Support.
...
- In Gmail, select Settings from your inbox toolbar.
 
- Select See all settings.
 
- In the General tab, go to the Dynamic email section and confirm the Enable dynamic email checkbox is selected.
 
- Next, select Developer Settings, and select the Always allow dynamic emails from this sender: checkbox.
 
- Enter the same domain as on your test message’s From address.
