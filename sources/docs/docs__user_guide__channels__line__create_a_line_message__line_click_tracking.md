---
url: https://www.braze.com/docs/user_guide/channels/line/create_a_line_message/line_click_tracking
slug: docs__user_guide__channels__line__create_a_line_message__line_click_tracking
title: "LINE click tracking"
...
- Drag a Text message into the composer and add a URL to the text field.

- Go to the Settings tab and confirm Click Tracking is turned on. Click tracking is turned on by default for all new messages.
...
- Drag a Rich message into the composer and select a template.
 
- Select URI for the On-click behavior for the applicable tappable area.
 
- Enter a URL into the Open URL field.
...
- Drag a Card-based message into the composer.
 
- Select URI for the On-click behavior for the applicable card or button areas.
...
LINE click tracking allows you to use your own domain to personalize the look and feel of your shortened URLs, helping portray a consistent brand image. For more information, refer to Custom domains.
...
The LINE performance table includes the column Total Clicks that shows a count of click events per variant and an associated click rate. For more details on LINE metrics, refer to LINE message performance.
...
Yes. When click tracking is turned on, you can retarget users who have clicked URLs by using the LINE retargeting filters.
