---
url: https://www.braze.com/docs/partners/ecommerce/analytics_workflow/tangerine
slug: docs__partners__ecommerce__analytics_workflow__tangerine
title: "Tangerine Store360"
description: "This article outlines the partnership between Braze and Tangerine Store360, an omnichannel platform that connects physical stores with online stores to provide superior in-store experiences..."
...
## Prerequisites
 ...
 Store360 account | 
 A Store360 account is required to take advantage of this partnership. | 

 Braze account ID | 
 Your Braze app group ID. | 

 Matching user IDs | 
 Your customer data in Store360 and Braze must have matching user IDs across the two platforms. | 
...
For reference, here are all the Braze fields available to be incorporated into Store360 analytics. The details of this step are very customer-specific and require special configurations. Talk to your Store360 account manager or [email protected] to learn more.
