---
url: https://www.braze.com/docs/partners/data_and_analytics/data_warehouses/snowflake/faqs
slug: docs__partners__data_and_analytics__data_warehouses__snowflake__faqs
...
- Drop the database that was created with the previous share.
 
- Create the database again according to the integration instructions.
 
- Re-grant any necessary access privileges to the new database.
 
- Recreate any views (if applicable) that referenced the old database.
...
The specified account is either not HIPAA-compliant or on Snowflake Editions lower than Business Critical. Your Snowflake account must be upgraded to the Business Critical Edition to be HIPAA-compliant for data sharing. Contact Snowflake support for further assistance with upgrading your account.
