---
url: https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/sources/user_profile
slug: docs__user_guide__messaging__design_and_edit__personalize__sources__user_profile
title: "User profile"
...
For a complete list of standard attribute tags, see Supported personalization tags.
...
For more information about creating and managing custom attributes, see Custom attributes.
...
Event properties are available in action-based campaigns and the first step of an action-based Canvas. For more information, see Custom events.
...
For more information, see API trigger properties object.
...
For the full list of device attribute tags, see Supported personalization tags.
...
For more information, see Setting default values.
