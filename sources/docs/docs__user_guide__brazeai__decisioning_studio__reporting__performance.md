---
url: https://www.braze.com/docs/user_guide/brazeai/decisioning_studio/reporting/performance
slug: docs__user_guide__brazeai__decisioning_studio__reporting__performance
...
- Braze defines what counts as an action (such as a send, click, purchase, or conversion).
 
- Braze defines how to measure that action daily (volume, revenue, unique people, and similar).
 
- Braze defines the business metric you want to see (such as conversion rate or revenue per user).
 
- Time rules and segmentation are applied.
 
- The Performance tab displays the results.
