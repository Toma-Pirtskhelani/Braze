---
url: https://www.braze.com/docs/partners/additional_channels_and_extensions/extensions/rewards/nift
slug: docs__partners__additional_channels_and_extensions__extensions__rewards__nift
title: "Nift"
...
Nift helps companies acquire, engage and retain customers. The two-sided platform helps partners thank their customers with Nift gift cards. Thanking customers increases their lifetime value and generates incremental revenue.
...
## Prerequisites
 ...
 Nift account | 
 A Nift account is required to take advantage of this partnership. | 

 Braze REST API key | 
 A Braze REST API key with all user data permissions. 
...
Visit your Nift dashboard, navigate to Accounts > Integrations > Braze, and click Connect.

### Step 2: Add Braze credentials

On the Link your Braze Account page, provide your Braze REST API key and select your Braze endpoint, which will depend on the Braze URL for your instance.
