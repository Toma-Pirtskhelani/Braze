---
url: https://www.braze.com/docs/partners/additional_channels_and_extensions/extensions/surveys/typeform
slug: docs__partners__additional_channels_and_extensions__extensions__surveys__typeform
title: "Typeform"
...
## Prerequisites
 ...
 Typeform account | 
 A Typeform account with access to webhooks are required to take advantage of this partnership. | 

 Braze Data Transformation | 
 A Data Transformation URL is necessary to receive data from Typeform. | 

## Integration

### Step 1: Set up the Braze Data Transformation to accept Typeform’s webhooks
...
Follow the steps in Typeform’s webhooks documentation to set up a webhook.
...
- Refresh your Data Transformation and make sure you can see the Typeform test payload in the Webhook Details.
 
- Update your Data Transformation code to support your chosen Typeform events.
 
- Click Validate to return a preview of your code’s output and to check if it’s an acceptable /users/track request.
 
- Save and activate your Data Transformation.
...
The following are example templates built using our example Typeform webhook payload. These templates can be used as a starting point. You can start from scratch or delete specific components as you see fit.
...
If you intend to use an email address as an identifier, review our frequently asked questions for the /users/track endpoint for more information on expected behavior.
...
See the section Monitoring your transformation for more information on monitoring and troubleshooting your transformation.
