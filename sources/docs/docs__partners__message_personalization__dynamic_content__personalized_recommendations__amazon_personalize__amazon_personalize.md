---
url: https://www.braze.com/docs/partners/message_personalization/dynamic_content/personalized_recommendations/amazon_personalize/amazon_personalize
slug: docs__partners__message_personalization__dynamic_content__personalized_recommendations__amazon_personalize__amazon_personalize
title: "Amazon Personalize"
description: "This reference article outlines a reference architecture for and integration between Braze and Amazon Personalize. This reference article will help you understand the use cases..."
...
## Prerequisites
 ...
 An AWS account is required to take advantage of this partnership. After you have an AWS account, you can access Amazon Personalize through the Amazon Personalize console, the AWS Command Line Interface (AWS CLI), or the AWS SDKs. | 

 Defined use cases | 
 Before creating a model, you must determine your use case for this integration. Reference the following list for common use cases. | 

 Datasets | 
 Amazon Personalize recommendation models require three different types of datasets, interactions, users, and items. Reference the following details to see the requirements for each dataset. | 
...
- The “User history length percentile” parameter found in the Amazon Personalize console lets you adjust the percentile of user history to include in the training:
...
Before running a Braze campaign, you must create a service that can serve these recommendations through an API. You can follow step 3 in the workshop article to deploy the service using AWS services. You can also deploy your own independent backend service that provides the recommendations.
