---
url: https://www.braze.com/docs/partners/message_orchestration/retargeting/remerge
slug: docs__partners__message_orchestration__retargeting__remerge
title: "Remerge"
description: "This reference article outlines the partnership between Braze and Remerge, a purpose-built app for retargeting at scale, arming you with tools to efficiently segment app..."
...
## Prerequisites
 ...
 Remerge account | 
 A Remerge account is required to take advantage of this partnership. | 

 Remerge webhook key | 
 This key will be provided by Remerge. | 
...
- Set the event name. This name will appear in your remerge.io dashboard.
