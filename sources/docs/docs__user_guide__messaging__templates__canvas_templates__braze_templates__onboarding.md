---
url: https://www.braze.com/docs/user_guide/messaging/templates/canvas_templates/braze_templates/onboarding
slug: docs__user_guide__messaging__templates__canvas_templates__braze_templates__onboarding
title: "Onboarding"
description: "This article describes how to use a Braze Canvas template to create onboarding journeys that promote strong initial adoption and encourage lasting relationships with your..."
...
Before using this template, you need to create the following email templates to reference in the Canvas:
...
- Update the Canvas name to specify that the Canvas is for onboarding new users.
 
- Update the description to specify that the Canvas maps out a user journey that promotes trust and loyalty with users.
...
- Select the Message step named “Welcome Email”.
 
- Select Edit message to replace the template’s email with our welcome email.
