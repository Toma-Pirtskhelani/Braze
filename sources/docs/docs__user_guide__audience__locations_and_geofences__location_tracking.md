---
url: https://www.braze.com/docs/user_guide/audience/locations_and_geofences/location_tracking
slug: docs__user_guide__audience__locations_and_geofences__location_tracking
...
For city or postal-level targeting, use setLastKnownLocation() (see the SDK article for your platform), your own IP geolocation service writing custom attributes, or Location targeting with the data you collect.
