---
url: https://www.braze.com/docs/api/endpoints/email/post_remove_spam
slug: docs__api__endpoints__email__post_remove_spam
title: "Remove email addresses from spam list"
...
To use this endpoint, you’ll need an API key with the email.spam.remove permission.
