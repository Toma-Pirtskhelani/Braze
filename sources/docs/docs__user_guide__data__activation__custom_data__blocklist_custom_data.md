---
url: https://www.braze.com/docs/user_guide/data/activation/custom_data/blocklist_custom_data
slug: docs__user_guide__data__activation__custom_data__blocklist_custom_data
title: "Blocklist custom data"
...
### Choosing blocklisting or deletion
...
Regardless of whether you blocklist or delete, those custom attributes, events, and purchases no longer appear on the Manage Workspace page and are removed as segment filters. If you delete custom data, Braze removes that user-level data from profiles according to How deletion works.
...
- Select the custom attribute, event, or product. For custom attributes and events, you can select up to 100 to blocklist at a time.
...
You must be a Braze admin to delete custom data.
