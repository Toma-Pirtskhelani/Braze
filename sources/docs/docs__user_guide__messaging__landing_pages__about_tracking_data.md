---
url: https://www.braze.com/docs/user_guide/messaging/landing_pages/about_tracking_data
slug: docs__user_guide__messaging__landing_pages__about_tracking_data
title: "About landing page tracking data"
...
- Trigger the /users/merge endpoint when a landing page form is submitted to merge the new profile with an existing profile.
 
- Schedule bulk merging to periodically merge duplicate profiles based on matching identifiers.
