---
url: https://www.braze.com/docs/partners/ecommerce/ordering_payments_subscription/stripe
slug: docs__partners__ecommerce__ordering_payments_subscription__stripe
title: "Stripe"
...
## Prerequisites
 ...
 Stripe account | 
 A Stripe account with access to webhooks is required to take advantage of this partnership. | 

 Braze Data Transformation | 
 A Data Transformation URL is necessary to receive data from Stripe. | 
...
- Refresh your Data Transformation and make sure you can see the Stripe test payload in the Webhook details section.
 
- Update your Data Transformation code to support your chosen Stripe events.
