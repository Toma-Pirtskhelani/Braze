---
url: https://www.braze.com/docs/user_guide/channels/email/best_practices/sunset_policies
slug: docs__user_guide__channels__email__best_practices__sunset_policies
title: "Sunset policies"
...
Use the Deliverability Center to track how mailbox providers see your sending:
...
For broader sending hygiene, see Improve email deliverability and Deliverability pitfalls and spam traps.

You can also leverage external tools such as Sender Score or Outlook Smart Network Data Services outside Braze for additional signals.
...
For example, if you have users who opt in to Apple’s Mail Privacy Protection (MPP), consider how this may impact your email campaigns and deliverability metrics and determine how to best structure your sunset policy.

To incorporate sunset policies into your campaigns, create a segment that automatically excludes users who have marked your emails as spam or have not interacted with your messages for a certain period of time.
...
When you apply the Last Engaged With Message filter, specify the type of messaging (push, email, or in-app notification) that the user has or has not interacted with, as well as the number of days it has been since the user last interacted. After you create a segment, choose to target this segment with any messaging channel.

While Braze automatically stops sending emails to users who have marked you as spam, the Has Marked You As Spam filter allows you to also send these users targeted push messages and in-app notifications. This filter is useful for retargeting campaigns. For instance, you can send unengaged users messages that remind them of the features and deals that they are missing out on when they don’t open your emails.
