---
url: https://www.braze.com/docs/user_guide/administer/global/privacy/managing_consent
slug: docs__user_guide__administer__global__privacy__managing_consent
...
- Teams: Use Braze teams for true governance. This involves adding a custom attribute to all user profiles to indicate their consent status, consent date, or both. You must then migrate all campaigns and Canvases to the designated team and adjust user permissions on the dashboard accordingly.
