---
url: https://www.braze.com/docs/user_guide/analytics/reports/funnel_reports
slug: docs__user_guide__analytics__reports__funnel_reports
...
Funnel Reports are not available for API campaigns.
...
#### Available funnel report events
 ...
 Campaign | 
 Started Session, Made Purchase, Performed Custom Event, Message Engagement Event | 

 Canvas | 
 Started Session, Made Purchase, Performed Custom Event, Received Canvas Step, Interacted with Step | 
