---
url: https://www.braze.com/docs/api/endpoints/export/user_data/post_users_global_control_group
slug: docs__api__endpoints__export__user_data__post_users_global_control_group
title: "Export user profile by Global Control Group"
...
To locate the segment identifier of your Global Control Group, refer to API identifier types.
...
## Request parameters
 ...
 Required* | 
 Array of Strings | 
 Name of user data fields to export, you may also export custom attributes. 
...
*Beginning April 2021, new accounts must specify specific fields to export. | 
 ...
 Optional | 
 String | 
 When using your own S3 bucket, allows to specify file format as zip or gzip. Defaults to ZIP file format. | 
