---
url: https://www.braze.com/docs/partners/message_orchestration/templates/sageflo
slug: docs__partners__message_orchestration__templates__sageflo
title: "Sageflo Radiate"
description: "This reference article outlines the partnership between Braze and Sageflo, a distributed marketing tool that empowers teams to easily send their own emails using marketing-approved..."
...
Sageflo Radiate is a distributed marketing tool that empowers local teams to easily send their own emails using marketing-approved templates, images, and audience segments through API integrations with Braze.
...
## Prerequisites
 ...
 Sageflo Radiate account | 
 A Sageflo Radiate account is required to take advantage of this partnership. | 

 Braze REST API key | 
 A Braze REST API key with full templates and campaigns permissions. 

 This can be created in the Braze dashboard from Settings > API Keys. | 

 Braze REST endpoint | 
 Your REST endpoint URL. Your API endpoint matches the dashboard URL for your Braze instance. 
