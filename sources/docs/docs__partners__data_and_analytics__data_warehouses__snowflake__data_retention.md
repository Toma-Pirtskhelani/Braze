---
url: https://www.braze.com/docs/partners/data_and_analytics/data_warehouses/snowflake/data_retention
slug: docs__partners__data_and_analytics__data_warehouses__snowflake__data_retention
title: "Snowflake data retention"
...
Braze automatically anonymizes events data for users that are deleted from Braze, as described in Data Protection Technical Assistance. Any data copied outside of the shared database will not be included in this process, as Braze no longer manages it.
...
- In your Snowflake account, create the procedure COPY_BRAZE_SHARE, which will be used to copy all the data shared by Braze to another database and schema within Snowflake.
...
- Run one of the following commands in your Snowflake account to execute the procedure.
...
- Create the procedure UNLOAD_BRAZE_SHARE, which will be used to copy all the data shared by Braze to the specified stage.
...
- Run one of the following commands to execute the procedure.
