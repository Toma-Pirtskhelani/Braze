---
url: https://www.braze.com/docs/user_guide/brazeai/predictive_suite/predictive_churn/messaging_users
slug: docs__user_guide__brazeai__predictive_suite__predictive_churn__messaging_users
