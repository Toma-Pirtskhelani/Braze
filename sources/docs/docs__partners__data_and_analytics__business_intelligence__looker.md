---
url: https://www.braze.com/docs/partners/data_and_analytics/business_intelligence/looker
slug: docs__partners__data_and_analytics__business_intelligence__looker
title: "Looker"
...
## Prerequisites
 ...
 Looker account | 
 A Looker account is required to take advantage of this partnership. | 
...
- Message engagement analytics block README
 
- User behavior analytics block README
...
### Available Blocks
 ...
 Message engagement analytics block | 
 This block includes data around push, email, in-app messages, webhook, conversion, Canvas entry, and campaign control group enrollment events. 

Learn more about this Looker Block, or check out the GitHub code. | 

 User behavior analytics block | 
 This block includes data around custom events, purchases, sessions, location events, and uninstalls.
...
- Within a Look with a braze_id dimension selected, click the settings gear ( ) in the toolbar, and select Send….
 
- Select the custom Braze Action.
 
- Under Unique Key, provide the primary user mapping key for the Braze account (external_id or braze_id).
 
- Give the export a name. If none is provided, LOOKER_EXPORT will be used.
 
- Under Advanced Options, select Results in Table or All Results and then Send.
