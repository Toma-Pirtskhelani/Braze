---
url: https://www.braze.com/docs/user_guide/brazeai/intelligence_suite/use_case
slug: docs__user_guide__brazeai__intelligence_suite__use_case
title: "Use case: Turn past app behavior into personalized offers on the right channel"
...
- In the Braze dashboard, Marvin navigates to Messaging > Canvas.
 
- He creates a Canvas and names it “Limited item - Super Sub”.
 
- He then adds one conversion event and another variant in the Canvas.
 
- He completes the remaining Canvas details and is now ready to map the user journey in the Canvas builder.
