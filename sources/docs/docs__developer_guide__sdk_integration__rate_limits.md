---
url: https://www.braze.com/docs/developer_guide/sdk_integration/rate_limits
slug: docs__developer_guide__sdk_integration__rate_limits
title: "Braze SDK rate limits"
...
Follow these best practices to help avoid rate limit issues:
 ...
 Focus on events that add value to analytics | 
...
When contacting Braze Support, include the following details for each of the networking SDK methods you use:
