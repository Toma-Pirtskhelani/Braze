---
url: https://www.braze.com/docs/user_guide/messaging/canvas/managing_canvases/canvas_version_history
slug: docs__user_guide__messaging__canvas__managing_canvases__canvas_version_history
...
For a full list of Canvases in your workspace (for example, for an audit), use the Export Canvas list endpoint and paginate through the results.
