---
url: https://www.braze.com/docs/partners/canvas_audience_sync/snapchat_audience_sync
slug: docs__partners__canvas_audience_sync__snapchat_audience_sync
title: "Audience Sync to Snapchat"
...
This feature allows users to control what specific first-party data is shared with Snapchat. At Braze, the integrations you can and cannot share your first-party data with are given the utmost consideration. For more information, refer to our privacy policy.
...
You must ensure the following items are created, completed and/or accepted before setting up your Snapchat Audience Step in Canvas.
 ...
 Snapchat | 
 A centralized tool to manage your brand’s Snapchat assets (such as ad accounts, pages, apps). | 

 Snapchat ad account | 
 Snapchat | 
 An active Snapchat ad account tied to your brand’s Snapchat Business Manager.

Ensure that your Snapchat Business Manager admin has granted you admin permissions to the Snapchat ad accounts you plan to use with Braze. | 

 Snapchat terms & policies | 
 Snapchat | 
...
You must have the “Admin” permission to connect Snapchat to your Braze account.
...
The following table includes metrics and descriptions to help you better understand analytics from your Audience Sync component.
 ...
 Entered | 
 Number of users who entered this component to be synced to Snapchat. | 
 ...
 Users Synced | 
 Number of users who have successfully been synced to Snapchat. | 

 Users Not Synced | 
 Number of users that have not been synced due to missing fields to match. | 

 Users Pending | 
 Number of users currently being processed by Braze to sync into Snapchat. | 

 Users Errored | 
 Number of users who were not synced to Snapchat due to an API error after about 13 hours of retries. Potential causes of errors can include an invalid Snapchat token or if the audience was deleted on Snapchat. | 
