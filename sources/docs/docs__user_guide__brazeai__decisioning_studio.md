---
url: https://www.braze.com/docs/user_guide/brazeai/decisioning_studio
slug: docs__user_guide__brazeai__decisioning_studio
title: "BrazeAI Decisioning Studio™"
description: "Get started with BrazeAI Decisioning StudioTM to make 1:1 AI decisions that maximize any business metric"
...
BrazeAI Decisioning Studio™ replaces A/B testing with decisioning agents that personalize everything, and maximize any metric: drive dollars, not clicks—with Decisioning Studio, you can optimize any business metric.
...
To learn more, or get started with Decisioning Studio, book a call with Braze.
...
- Get Started with Decisioning Studio
 
- Setting up Decisioning Studio Go
