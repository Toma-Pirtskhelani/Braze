---
url: https://www.braze.com/docs/api/endpoints/export/user_data/post_users_segment
slug: docs__api__endpoints__export__user_data__post_users_segment
title: "Export user profile by segment"
...
1. The fields_to_export field in this API request is required.
...
braze.docs.bucket/segment-export/abc56c0c-rd4a-pb0a-870pdf4db07q/2019-04-25/d9696570-dfb7-45ae-baa2-25e302r2da27-1556044807/114f0226319130e1a4770f2602b5639a.zip
 ...
 bucket-name | 
 Fixed based on your bucket name. | 
 braze.docs.bucket | 
 ...
 SEGMENT_ID | 
 Included in the export request. | 
 abc56c0c-rd4a-pb0a-870pdf4db07q | 

 YYYY-MM-dd | 
 The date the successful callback is received. | 
 2019-04-25 | 

 RANDOM_UUID | 
 A random UUID generated by Braze at the time of the request. | 
 d9696570-dfb7-45ae-baa2-25e302r2da27 | 

 TIMESTAMP_WHEN_EXPORT_STARTED | 
 Unix time (seconds since 2017-01-01:00:00:00Z) that the export was requested in UTC. | 
 1556044807 | 

 filename | 
 Random per file. | 
 114f0226319130e1a4770f2602b5639a | 
...
## Request parameters
 ...
 Required | 
 String | 
 Identifier for the segment to be exported. See segment identifier.

The segment_id for a given segment can be found from the API Keys page within your Braze account or you can use the Segment List Endpoint. | 

 callback_endpoint | 
 Optional | 
 String | 
 Endpoint to post a download URL to when the export is available. | 

 fields_to_export | 
 Required* | 
 Array of strings | 
 Name of user data fields to export. You can also export all custom attributes by including custom_attributes in this parameter. Reference Fields to export for a complete list of fields you can export. | 

 custom_attributes_to_export | 
 Optional | 
 Array of strings | 
 Names of specific custom attributes to export (up to 500). Omit custom_attributes from fields_to_export when you use this parameter, or Braze exports every custom attribute regardless of this list. To create and manage custom attributes in the dashboard, go to Data Settings > Custom Attributes. | 

 output_format | 
 Optional | 
 String | 
 The output format of your file. Defaults to zip file format. If you are using your own S3 bucket, you can specify zip or gzip. | 
...
All fields are strings. | 
 ...
 created_from | 
 String | 
 Method used to create the user profile (for example, SDK, REST API, or CSV import). | 
...
- nil: unknown | 
 ...
 phone | 
 String | 
 User’s phone number in the format that was imported into Braze. For example, if a request to add a phone number comes in as 1234567890, then it is exported in the same format. | 
 ...
 push_tokens | 
 Array | 
 Information about the user’s push tokens. | 
...
- A 403 Forbidden response often means the export file isn’t ready yet.
