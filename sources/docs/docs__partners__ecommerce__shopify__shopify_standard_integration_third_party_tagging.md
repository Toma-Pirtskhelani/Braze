---
url: https://www.braze.com/docs/partners/ecommerce/shopify/shopify_standard_integration_third_party_tagging
slug: docs__partners__ecommerce__shopify__shopify_standard_integration_third_party_tagging
title: "Shopify standard integration with third-party tagging tool"
...
This page guides you through using third-party tools, like Google Tag Manager, with the Shopify standard integration to initialize and load the Braze Web SDK.
...
- Follow the provided steps in Shopify standard integration setup. While enabling Braze Web SDKs, check the box indicating that you’re using a third-party tool to add the Braze Web SDK to your Shopify site.
 
- Go to Settings > App Settings, select the Shopify web app, and then copy the API key for Shopify on Web.
 
- Paste the API key into your third-party tool’s web SDK configuration and set the SDK version to match the Braze Shopify integration.
