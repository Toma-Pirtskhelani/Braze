---
url: https://www.braze.com/docs/user_guide/messaging/campaigns/ideas_and_strategies/capturing_lapsing_users
slug: docs__user_guide__messaging__campaigns__ideas_and_strategies__capturing_lapsing_users
title: "Capture lapsing users"
...
For more on targeting users, check out our Braze Learning course on campaign setup!
...
Next, click Create Campaign and choose the type of campaign we will be sending to this segment. in this example, we’ll create a new push campaign.
