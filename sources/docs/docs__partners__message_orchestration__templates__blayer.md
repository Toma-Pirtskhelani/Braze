---
url: https://www.braze.com/docs/partners/message_orchestration/templates/blayer
slug: docs__partners__message_orchestration__templates__blayer
title: "B.Layer"
description: "This reference article outlines the partnership between Braze and B.Layer, an in-app message builder, you can use to create custom-designed in-app messages simply, rapidly, and..."
...
B.Layer is Phiture’s in-app message builder that helps mobile apps’ CRM teams to create custom-designed in-app messages simply, rapidly, and without coding.
...
## Prerequisites
 ...
 B.Layer account | 
 A B.Layer account is required to take advantage of this partnership. | 
