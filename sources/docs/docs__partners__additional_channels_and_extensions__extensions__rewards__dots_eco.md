---
url: https://www.braze.com/docs/partners/additional_channels_and_extensions/extensions/rewards/dots_eco
slug: docs__partners__additional_channels_and_extensions__extensions__rewards__dots_eco
title: "DOTS.ECO"
...
This integration is maintained by DOTS.ECO.
...
Before you begin, you need the following:
 ...
 DOTS.ECO account | 
 DOTS.ECO account access. | 

 DOTS.ECO credentials | 
 The request in this article requires a DOTS.ECO app token, API key, and allocation ID. To retrieve these, contact your DOTS.ECO customer success manager. | 

 Braze REST API key | 
 A Braze REST API key with users.track permissions. Create this key in the Braze dashboard under Settings > API Keys. | 
