---
url: https://www.braze.com/docs/api/endpoints/templates/content_blocks_templates/post_update_content_block
slug: docs__api__endpoints__templates__content_blocks_templates__post_update_content_block
...
You can also call this endpoint through the Braze MCP server using the update_content_block function. This lets AI tools like Claude and Cursor update content blocks through natural language prompts.
...
## Request parameters
 ...
 Required | 
 String | 
 Your Content Block’s API identifier. | 
 ...
 Optional | 
 String | 
 HTML or text content within Content Blocks. | 
...
The following table lists possible returned errors and their associated troubleshooting steps.
 ...
 Make sure your content is encapsulated in quotes (""). | 

 Content must be smaller than 50kb | 
 The content in your Content Block must be less than 50 KB total. | 

 Content contains malformed liquid | 
 The Liquid provided is not valid or parsable. Try again with valid Liquid or contact support. | 
 ...
 Make sure your Content Block description is encapsulated in quotes (""). | 
 ...
 To add a tag when creating a Content Block, the tag must already exist in Braze. | 
