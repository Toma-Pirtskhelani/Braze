---
url: https://www.braze.com/docs/user_guide/brazeai/predictive_suite/predictive_churn/troubleshooting
slug: docs__user_guide__brazeai__predictive_suite__predictive_churn__troubleshooting
title: "Troubleshoot Predictive Churn"
...
Use this page to resolve Predictive Churn training and audience errors. For analytics and model quality, see Predictive Churn analytics.
...
Match the error message, warning, or outcome you see when building a prediction to the section that explains how to fix it.
 ...
 “Not enough past non-churners” warning | 
 Prediction audience too small | 

 Prediction audience exceeds size limit | 
 Prediction audience too large | 

 Prediction quality below 40% | 
 Prediction has poor quality | 

 Unsure whether your data fits the model | 
 Data considerations | 
...
- Confirm Predictive Churn is turned on for your company and the workspace has sufficient Monthly Active Users (MAU)—typically 300,000 MAU in a single workspace.
 
- Review your churn definition. Overly restrictive filters reduce the number of churned users available for training.
 
- Review your prediction audience definition. Too few historic non-churners blocks model training.
 
- Confirm custom events (not custom attributes alone) capture the high-value actions that indicate churn risk.
 
- If errors persist after broadening definitions, contact Braze Support.
...
Symptom: Prediction quality is 39% or lower.
