---
url: https://www.braze.com/docs/user_guide/messaging/campaigns/schedule_your_campaign/triggered_delivery/campaign_connector
slug: docs__user_guide__messaging__campaigns__schedule_your_campaign__triggered_delivery__campaign_connector
...
Campaign Connector triggers cannot be used to trigger in-app message campaigns. In-app messages can only be triggered by SDK events, such as custom events or session start. For more information, see Create an in-app message.
...
- Select Action-Based Delivery and add the “Interact with Campaign” trigger to target users who interact with an active campaign.
 
- Choose the trigger interaction.
 
- Next, you’ll select the active campaign that you’d like to target.
