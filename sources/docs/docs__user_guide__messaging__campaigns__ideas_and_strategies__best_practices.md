---
url: https://www.braze.com/docs/user_guide/messaging/campaigns/ideas_and_strategies/best_practices
slug: docs__user_guide__messaging__campaigns__ideas_and_strategies__best_practices
...
- Target your audiences by building audience segments.
 
- Trigger your messages with action-based or API-triggered delivery.
 
- Template and personalize your messages with Liquid conditional logic.
 
- Track the efficacy of your campaigns with conversion tracking.
...
As you build out your campaigns over time, you may notice lapses in your audience. At this crucial point, you can target your lapsing users with a specialized campaign using segmentation.

### Identify your audience

Leverage segments and filters to your advantage by defining your audience. Consider who your campaign and messages are targeting. With this key information, you can create multichannel campaigns that offer the flexibility of building your messages in different channels to match your audience’s notification preferences.

It’s also important to understand your active users to show your appreciation to your consistent users.

## Multichannel campaigns

### Feature awareness

If your goal is to draw your users toward a new feature or app version, use a multichannel strategy with a focus on in-app channels. In-app messages and Content Cards are generally less disruptive if a user doesn’t wish to update immediately.

Be sure to include deep links to the appropriate app store.
...
For Canvas scheduling nuances (drafts, stops, and evaluation near send time), see Canvas best practices.
