---
url: https://www.braze.com/docs/user_guide/brazeai/predictive_suite/predictive_churn/analytics
slug: docs__user_guide__brazeai__predictive_suite__predictive_churn__analytics
...
Users in the prediction audience will be assigned a Churn Risk Score between 0 and 100. The higher the score, the greater the likelihood of churn.

- Users with scores between 0 and 50 will be labeled in the Low Risk category.
 
- Users with scores between 50 and 75, and 75 and 100 will be labeled in the Medium Risk and High Risk categories, respectively.
