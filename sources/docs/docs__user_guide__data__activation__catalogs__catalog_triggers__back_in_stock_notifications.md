---
url: https://www.braze.com/docs/user_guide/data/activation/catalogs/catalog_triggers/back_in_stock_notifications
slug: docs__user_guide__data__activation__catalogs__catalog_triggers__back_in_stock_notifications
title: "Back-in-stock notifications"
description: "Learn how to set up back-in-stock notifications using your catalog and custom events, so you can automatically subscribe customers to receive notifications when an item..."
...
- Select the Back in stock toggle.
 
- If the global back-in-stock settings have not been configured, you will be prompted to set up the custom events and properties that will be used to trigger back-in-stock notifications:
...
- Select Save and continue to the catalog’s Settings page.
 
- Set your notification rule. There are two options:
...
- Set the Inventory field in catalog. This catalog field will be used to determine if the item is out of stock. The field must be a number type.
...
- Select Back in stock as the trigger.
 
- Select the name of the catalog with the back-in-stock notifications.
