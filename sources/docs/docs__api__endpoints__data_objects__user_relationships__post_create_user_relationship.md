---
url: https://www.braze.com/docs/api/endpoints/data_objects/user_relationships/post_create_user_relationship
slug: docs__api__endpoints__data_objects__user_relationships__post_create_user_relationship
...
To use this endpoint, you need an API key with data_objects.user_relationships.create.
...
The following table lists and describes the fields in a successful response.
 ...
 Required | 
 Object | 
 Created user relationship record | 
...
The following table lists common errors for this endpoint and how to resolve them.
 ...
 400 | 
 Unknown rel_kind for the type or schema validation error | 
 ...
 409 | 
 Duplicate relationship (duplicate-user-relationship) | 
 ...
 Confirm the key has data_objects.user_relationships.create and that your source IP is on the key allowlist, if configured. | 
