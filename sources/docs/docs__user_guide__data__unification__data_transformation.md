---
url: https://www.braze.com/docs/user_guide/data/unification/data_transformation
slug: docs__user_guide__data__unification__data_transformation
...
The following table describes the differences between the free and pro version of Data Transformation.
 ...
 Area | 
 Free Version | 
 Data Transformation Pro | 

 Active transformations | 
 Up to 5 per company | 
 Up to 55 per company | 

 Per month | 
 300,000 incoming requests per month | 
 10,300,000 incoming requests per month | 
